<ul class="list-group">
    ...
    <li class="list-group-item"><a href="{{route('report_execution_reconcillation',['audit_id' => $audit_details->id, 'module_id' => 4])}}">Reconciliation </a></li>
    ...
    <li class="list-group-item"><a href="{{route('report_execution_stock_count',['audit_id' => $audit_details->id, 'module_id' => 6])}}">Stock Count</a></li>
